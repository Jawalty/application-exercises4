...
**Your answer:** Six laureates

**Task 1.2:** What variables are in the dataset?

**Your answer:**

There is ID, surname, first name, year, category, and affiliation
...
**Your answer:** There are 544 non-STEM laureates
...
**Does this equal TRUE?** It shows false
...
write_csv(nobel_stem, "data/stem.csv")
```
...
write_csv(nobel_non_stem, "data/nobel-stem.csv")
```
...
**Does the number of rows match what you expected?** It has the number of rows that the nobel_non_stem data has.
...
**Your answer:** The Peace category had the most non-STEM laureates.
