...
**How many observations (bookings) are in the dataset?** _119390____

**How many variables are there?** _32____

**What is the data type of the `hotel` variable?** _character____

**What is the data type of the `lead_time` variable?** __numeric___

**How many missing values does the `children` variable have?** _4____
...
There are far less spontaneous non-US travelers than there are from the US. 
The US is responsible for a large ratio of the spontaneous travel where you 
stay at a hotel. This could also mean that non-US travelers are also visiting 
family or friends when they travel.
---
...
**Your answer:** About 7.816% of bookings include children or babies.
...
**Your prediction:** I think city hotels will have more bookings with children/babies because a lot of people will be traveling for work, vacations, or sports/events for their children. Resort hotels seem like adult vacation getaways, rather than family vacations.
...
City  hotels had higher bookings with at least one baby or child, and my prediction was correct.
...
There are some bookings for 0 adults as well as up to 27 adults.
...
The unusual values (like 0 adults) appear more frequently in not canceled bookings. This suggests that there would more likely be no mistake in the booking of 0 adults, rather than there would be.
...
The maximum adr for the city hotel is 5400 which is over 10x more than the 
resort hotel. The resort hotel also has a minimum adr value of -6.38 which
would essentially mean they are paying you to stay there.
...
They could have been given a room they weren't expecting and there was compensation
...
It could be a supreme luxury room, but this is likely a mistake.

**Task 8.3:** Should these unusual values be removed from the dataset? Why or why not?

**Your answer:**

I would argue outliers are important and can shine light on hidden mistakes, so I would say no.
...
The negative adr was interesting, as well as the stats on non-US travelers.
**Which data wrangling skill was most useful in this exercise?**

The filtering and "group by" functions are great for visualizing and interpreting
this data.

**What would you want to investigate further in this dataset?**

I would want to dive deeper into the non-US travelers and see more details behind 
